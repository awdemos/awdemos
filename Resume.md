...
[github.com/awdemos](https://github.com/awdemos)

## Professional Summary

AI and DevOps platform leader with 20+ years in technology — from selling Linux supercomputers and building Top 500 HPC systems, to leading AI infrastructure for national defense. Proven track record in production AI/ML platforms, cloud architecture, and memory-safe systems engineering in Rust and Go.
...
- Reported to Dr. Doug Lenat; supported symbolic AI and reasoning systems for defense and healthcare
...
**Linux HPC Sales Engineer & Systems Administrator** | Earlier Career (SF Web 2.0 era)
- Sold Linux supercomputers and built Top 500 HPC systems for research institutions
- Supported infrastructure at high-growth startups including LiveJournal and OpenDNS
- Deep cross-platform experience (Mac, Linux, Windows) in startup environments

## Certifications

- AI Makerspace AI Engineer Cohort 5 (Present)
- Rust Foundations Course (2025)
- Nvidia Technical Advisor — DGX SuperPOD, AI Infrastructure, InfiniBand (2024)
- Dell AI Advisor (2024)
- Foundations to SLMs Cohort 3 (2024)
- Securing the AI/ML Supply Chain — Linux Foundation / Sigstore (2024)
...
**Portfolio & Certs:** [github.com/awdemos](https://github.com/awdemos) | [certs directory](https://github.com/awdemos/demos/tree/main/certs)
